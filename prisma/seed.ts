...
async function main() {
  ...
  await prisma.userPreferenceCache.deleteMany()
  ...
  await prisma.novelBackup.deleteMany()
  await prisma.importExportTask.deleteMany()
  await prisma.rankingSnapshot.deleteMany()
  await prisma.rankingCache.deleteMany()
  await prisma.novelDailyStat.deleteMany()
  await prisma.novelPeriodStat.deleteMany()
